// $Header: /usr/local/cvsroot/courses/cs246/project/java/Builder.java,v 1.10 2006/06/21 18:45:18 emerrill Exp $
   ...
   implements FilenameFilter
{
   ...
   /**
    * Whether or not to build Sign jars.
    */
   boolean mSign;

   /**
    * the SignerUtil to use for signing
    */
   private SignerUtil signer;
   ...
   public Builder(String[] args)
   {
      ...
      signer = new SignerUtil(System.getProperty("user.home") + separator +
            "our246" + separator + "project" + separator + "config" +
            separator + "signer.Config");
      signer.setKeystore(System.getProperty("user.home") + separator +
         "our246" + separator + "project" + separator + "config" + separator +
         "sudokuKeystore");
   }
   ...
   private void init()
   {
      ...
      for (String arg : mArgs)
      {
         ...
         else if (arg.equalsIgnoreCase("sign"))
         {
            mSign = true;
         }
      }
   ...
   public void buildOne(String module) throws Exception
   {
      ...
      else // compile all the newer .java files
      {
         ...
         if (compilerExitStatus == 0)
         {
            ...
            if (status && mSign)
            {
               signer.sign(mJarFile.getCanonicalPath());
            }
         }
         else
         {
