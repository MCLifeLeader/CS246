...
public class GenEps {
	...
	public void paint(Graphics2D g2d) { //perform drawing operations
	...
	public void createAndOutputEPSToFile(String filename) {
	  try {
		OutputStream ostream = new FileOutputStream(filename);
		createEpsToStream(ostream);
	  } catch (Exception e) {
		System.out.println("IO Exception.");
	  }
	}

	public void createEpsToStream(OutputStream outputStream) { //create and write stream to file
		try {
